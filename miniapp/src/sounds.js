// ===== Менеджер звука: UI-звуки + амбиент биомов с плавной громкостью =====
let volumes = { master: 0.8, ui: 1, amb: 0.8 };
try {
  const s = JSON.parse(localStorage.getItem("snd") || "null");
  if (s) volumes = { ...volumes, ...s };
} catch {}
...
// ===== Амбиент: forest / mountain / sea, loop =====
